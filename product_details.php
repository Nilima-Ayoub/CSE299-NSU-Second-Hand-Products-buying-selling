...
<div class="container mt-2" >
  ...
  <div class="row row-cols-1 row-cols-md-2" id="productcard">
<?php
$query = mysqli_query(
  $mysqli_connection,
...
<?php for ($i = 0; $i < $RowCount; ++$i) {
  $row = mysqli_fetch_array($query); ?>
    ...
    <div class="col">
  <div class="card ms-5" style="border:transparent;">
...
<div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <img src="img/<?php echo $row['img1']; ?>"  class="img-fluid rounded-start product_detail_img" alt="..." style="width:560px; height:450px;" >
  ...
  <h5 class="card-title mb-3">Product details</h5>
    ...
    <a href="order.php?id=<?php echo $row['id']; ?>"  class="btn btn-outline-secondary text-black ms-4" ><i class="fa-solid fa-bag-shopping"></i>  Order Now</a> 
    <?php
      }
    }
